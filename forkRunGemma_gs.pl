...
$g = "fha2013_gen_full_gs.geno";
#$g = "fha2013_gen_gs.geno";
...
foreach $p (@ARGV){
	...
	foreach $ph (1..1){ 
		foreach $ch (0..9){
			...
			$pm->start and next;
			if($ch==0){
				$o = "o_fha2013_mel_gs_lmm_ph$ph";
				#$o = "o_fha2013_gs_lmm_ph$ph";
    				system "gemma -g $g -p $p -gk 1 -o $o -maf 0\n";
    				system "gemma -g $g -p $p -k output/$o.cXX.txt -lmm 4 -n $ph -o $o -maf 0\n";
			}
			$o = "o_fha2013_mel_gs_bslmm_ph$ph"."_ch$ch";
			#$o = "o_fha2013_gs_bslmm_ph$ph"."_ch$ch";
